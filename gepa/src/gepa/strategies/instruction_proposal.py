...
- Some problems may show insufficient reasoning that appears too hasty - identify these and guide the assistant to think more carefully for complex cases
- Match reasoning depth to problem complexity: simple problems should have brief, direct reasoning; complex problems require thorough, multi-step analysis
- Optimize for token efficiency: avoid wasting tokens on obvious steps while ensuring critical thinking for challenging aspects
- Include guidance on when to "think twice" (complex logic, edge cases, multi-step problems) vs. when to proceed directly (straightforward, well-defined tasks)

In your new instruction, explicitly guide the assistant on how to calibrate reasoning depth based on problem characteristics. This reasoning routing approach should help the assistant allocate cognitive effort appropriately.
